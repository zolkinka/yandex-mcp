...
- [ATTACHMENTS.md](ATTACHMENTS.md) - Работа с вложениями файлов
- [QUEUE_MANAGEMENT.md](QUEUE_MANAGEMENT.md) - Управление очередями задач
- [HTTP_SERVER.md](HTTP_SERVER.md) - HTTP/HTTPS режим для ChatGPT
